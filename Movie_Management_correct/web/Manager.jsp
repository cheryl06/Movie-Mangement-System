  ...
  <div class="header">
    <div class="header_resize">
      <div class="menu_nav">
        ...
        <div class="clr"></div>
      <div class="logo">
          <h1><a href="Login.jsp"><span>Admin login here</span></a></h1>
      </div>
        <div class="userentry">
        <form id="formsearch" name="formsearch" method="post" action="ManagerLogin">
            <table>
                <tr><td><div class="res2"><strong>UserID</strong></div></td>
                    <td><input name="m_username" id="m_username" maxlength="80" value="" type="text" /></td></tr>
         
                <tr><td><div class="res2"><strong>Password</strong></div></td>
                    <td><input name="m_password" id="m_password" maxlength="80" value="" type="password" /></td></tr>
                <tr>
                    <td></td>
